        ...
        <div class="glass-card">
            <div class="p-4" style="background: var(--purple-gradient); border-radius: 20px 20px 0 0;">
                <h3 class="mb-0 text-white">
                    <i class="bi bi-person-badge me-2"></i> Cadastrar Novo Personagem
                </h3>
            </div>
            <div class="p-4">
                <form action="?pg=personagem-cadastro" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-6 mb-3">
                            ...
                            <input type="number" class="form-control" 
                                   id="forca" name="forca" min="1" max="30" value="10"
                                   style="background: rgba(99, 102, 241, 0.1); border: 1px solid rgba(99, 102, 241, 0.3); color: var(--text-primary); border-radius: 12px; padding: 0.75rem 1rem;">
                        </div>
                        ...
                        <div class="col-md-4 col-6 mb-3">
                            ...
                            <input type="number" class="form-control" 
                                   id="destreza" name="destreza" min="1" max="30" value="10"
                                   style="background: rgba(99, 102, 241, 0.1); border: 1px solid rgba(99, 102, 241, 0.3); color: var(--text-primary); border-radius: 12px; padding: 0.75rem 1rem;">
                        </div>
                        ...
                        <div class="col-md-4 col-6 mb-3">
                            ...
                            <input type="number" class="form-control" 
                                   id="constituicao" name="constituicao" min="1" max="30" value="10"
                                   style="background: rgba(99, 102, 241, 0.1); border: 1px solid rgba(99, 102, 241, 0.3); color: var(--text-primary); border-radius: 12px; padding: 0.75rem 1rem;">
                        </div>
                        ...
                        <div class="col-md-4 col-6 mb-3">
                            ...
                            <input type="number" class="form-control" 
                                   id="inteligencia" name="inteligencia" min="1" max="30" value="10"
                                   style="background: rgba(99, 102, 241, 0.1); border: 1px solid rgba(99, 102, 241, 0.3); color: var(--text-primary); border-radius: 12px; padding: 0.75rem 1rem;">
                        </div>
                        ...
                        <div class="col-md-4 col-6 mb-3">
                            ...
                            <input type="number" class="form-control" 
                                   id="sabedoria" name="sabedoria" min="1" max="30" value="10"
                                   style="background: rgba(99, 102, 241, 0.1); border: 1px solid rgba(99, 102, 241, 0.3); color: var(--text-primary); border-radius: 12px; padding: 0.75rem 1rem;">
                        </div>
                        ...
                        <div class="col-md-4 col-6 mb-3">
                            ...
                            <input type="number" class="form-control" 
                                   id="carisma" name="carisma" min="1" max="30" value="10"
                                   style="background: rgba(99, 102, 241, 0.1); border: 1px solid rgba(99, 102, 241, 0.3); color: var(--text-primary); border-radius: 12px; padding: 0.75rem 1rem;">
                        </div>
                    </div>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                        ...
                        <button type="submit" class="btn btn-modern" style="background: var(--purple-gradient); box-shadow: 0 4px 15px rgba(124, 58, 237, 0.3);">
                            <i class="bi bi-check-circle me-2"></i> Cadastrar Personagem
                        </button>
                    </div>
                </form>
            </div>
